...
class AppointmentRescheduledTherapistMail extends Mailable implements ShouldQueue
{
    ...
    {
        return $this->subject('Un client a déplacé son rendez-vous')
            ->markdown('emails.appointments.rescheduled-therapist', [

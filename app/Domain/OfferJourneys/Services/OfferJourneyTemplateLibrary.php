...
class OfferJourneyTemplateLibrary
{
    public function all(): Collection
    {
        return collect([
            ...
            'free_guide' => $this->template('Guide gratuit', 'lead_magnet', 'Proposer une ressource utile en échange d’une adresse email.', 'Recevoir le guide', 'Recevez une ressource pratique pour mieux comprendre le sujet et préparer la suite.', 'Ce guide s’adresse aux personnes qui souhaitent avancer à leur rythme avec des repères simples.', ['Des explications accessibles', 'Une méthode ou une checklist concrète', 'Des pistes pour choisir la prochaine étape'], ['Indiquez votre adresse email', 'Accédez immédiatement à la ressource', 'Recevez également le lien par email']),

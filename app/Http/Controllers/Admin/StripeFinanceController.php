...
class StripeFinanceController extends Controller
{
    ...
    ): array
    {
        ...
        return [
            ...
            'annual_new_conservative_cents' => $newBusiness['annual_conservative_cents'],
            'annual_new_expected_cents' => $newBusiness['annual_expected_cents'],
            'annual_new_optimistic_cents' => $newBusiness['annual_optimistic_cents'],

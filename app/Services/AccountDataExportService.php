...
class AccountDataExportService
{
    ...
    private function datasets(): array
    {
        return [
            ...
            ['label' => 'Formations incluses dans les packs', 'table' => 'digital_training_pack_product', 'path' => 'catalogue/formations-packs.csv'],
    ...
    private function ownedQuery(string $table, int $userId): Builder
    {
        ...
        return match ($table) {
            ...
            'digital_training_pack_product' => $this->twoParents($query, 'pack_product_id', 'pack_products', 'digital_training_id', 'digital_trainings', $userId),

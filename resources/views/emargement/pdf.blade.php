...
<body>
    <div class="header">
        ...
        <div class="subtitle muted">Document généré automatiquement par Olithea</div>
    </div>
    ...
    <div class="grid">
        ...
        <div class="footer">
            ...
            Il a été généré automatiquement par le système Olithea à partir des informations

        ...
        <div class="details-container mx-auto p-4">
            ...
            <form action="{{ route('products.storeDuplicate', $product->id) }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="details-box">
                    ...
                    <input type="checkbox" id="collect_payment" name="collect_payment" value="1"
                           {{ old('collect_payment', $product->collect_payment) ? 'checked' : '' }}>
                ...
                <div class="details-box">
                    ...
                    <input type="number" id="tax_rate" name="tax_rate" class="form-control"
                           value="{{ old('tax_rate', $product->tax_rate) }}" step="0.01" min="0" max="100" required>
                ...
                <div class="details-box">
                    ...
                    <input type="number" id="duration" name="duration" class="form-control"
                           value="{{ old('duration', $product->duration) }}" min="1">
                ...
                <div class="details-box">
                    ...
                    <select id="mode" name="mode" class="form-control" required>
                        <option value="visio" {{ old('mode', $product->visio ? 'visio' : '') == 'visio' ? 'selected' : '' }}>
                            {{ __('Visio') }}
                        </option>
                        <option value="adomicile" {{ old('mode', $product->adomicile ? 'adomicile' : '') == 'adomicile' ? 'selected' : '' }}>
                            {{ __('À domicile') }}
                        </option>
                        <option value="dans_le_cabinet" {{ old('mode', $product->dans_le_cabinet ? 'dans_le_cabinet' : '') == 'dans_le_cabinet' ? 'selected' : '' }}>
                            {{ __('Dans le cabinet') }}
                        </option>
                    </select>
                ...
                <div class="details-box">
                    ...
                    <input type="checkbox" id="can_be_booked_online" name="can_be_booked_online" value="1"
                           {{ old('can_be_booked_online', $product->can_be_booked_online) ? 'checked' : '' }}>
                ...
                <!-- === Options avancées (juste 2 champs) === -->
                <div class="advanced-wrapper">
                    <button type="button" class="adv-toggle"
                            @click="adv = !adv" :aria-expanded="adv ? 'true' : 'false'">
                        ...
                        <div class="adv-box">
                            ...
                            <div class="details-box">
                                ...
                                <small class="text-gray-500">
                                    {{ __('Si coché, chaque rendez-vous créé avec cette prestation pourra déclencher un envoi de feuille d’émargement à signer (lien magique, 14 jours).') }}
                                </small>
                            </div>
                        </div>
                    </div>

...
<nav x-data="{ open: false }" class="bg-white border-b border-gray-100">
    <!-- Inclure Alpine.js si ce n'est pas deja fait ailleurs -->
                    ...
                    <div class="relative flex items-center"
                        ...
                        <x-nav-link href="#"
                                    ...
                                    :active="request()->routeIs('availabilities.*')
                                              ...
                                              || request()->routeIs('session-note-templates.*')
                        ...
                        <div x-show="openConfig"
                            ...
                            <a href="{{ route('session-note-templates.index') }}" class="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100 {{ request()->routeIs('session-note-templates.*') ? 'bg-gray-50 font-medium' : '' }}">
                                {{ __('Modèles de notes') }}
                            </a>
    ...
    <div :class="{ 'block': open, 'hidden': ! open }" class="hidden lg:hidden">
        <div class="pt-2 pb-3 space-y-1">
            ...
            <x-responsive-nav-link :href="route('session-note-templates.index')" :active="request()->routeIs('session-note-templates.*')" class="text-[#647a0b] hover:text-[#854f38]">
                {{ __('Modèles de notes') }}
            </x-responsive-nav-link>

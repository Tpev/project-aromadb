<x-app-layout>
    ...
    <div class="container mt-5" style="max-width: 760px;">
        <div class="details-container mx-auto p-4" style="background:#f9f9f9;border-radius:10px;box-shadow:0 5px 15px rgba(0,0,0,.1);">
            <h1 class="details-title text-center mb-4" style="font-size:1.9rem;font-weight:700;color:#6B4A3A;">
            ...
            <div class="mb-4 p-3" style="background:#fff;border:1px solid rgba(107, 74, 58,.2);border-radius:8px;">

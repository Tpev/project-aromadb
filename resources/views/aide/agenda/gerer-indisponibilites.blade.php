<x-app-layout>
    @section('title', 'Gérer les indisponibilités agenda | Olithea')
    @section('meta_description')
Bloquez congés, absences et fermetures dans Olithea pour éviter les réservations non souhaitées et garder un agenda praticien fiable.
    @endsection

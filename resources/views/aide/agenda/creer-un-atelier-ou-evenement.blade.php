<x-app-layout>
    @section('title', 'Créer un atelier ou événement | Agenda Olithea')
    @section('meta_description')
Créez ateliers et événements (présentiel ou visio), gérez places, réservations, paiement Stripe et publication sur votre Portail Pro avec Olithea.
    @endsection
    ...
    <section class="py-16 bg-white">
        <div class="container mx-auto px-4 max-w-4xl">
            ...
            <p class="text-lg text-gray-600 mb-8 leading-relaxed">
                L’agenda Olithea permet de gérer vos formats collectifs :

<x-app-layout>
    @section('title', 'Synchroniser agenda Google, Apple, Outlook | Olithea')
    @section('meta_description')
Connectez Google Agenda à Olithea, gérez la couleur des événements et utilisez l’export ICS pour Apple Calendar et Outlook.
    @endsection
    ...
    <section class="py-16 bg-white">
        <div class="container mx-auto px-4 max-w-4xl">
            ...
            <p class="text-lg text-gray-600 mb-8 leading-relaxed">
                ...
                Dans Olithea, la connexion native se fait avec <strong>Google Agenda</strong>,

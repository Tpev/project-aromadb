<x-app-layout>
    @section('title', 'Configurer ses disponibilités et horaires types | Agenda praticien | Olithea')
    @section('meta_description')
Apprenez à configurer vos disponibilités et horaires types dans Olithea : semaines types, créneaux de travail et organisation de l’agenda pour les praticiens et thérapeutes.
    @endsection
    ...
    <section class="py-16 bg-white">
        <div class="container mx-auto px-4 max-w-4xl">
            ...
            <p class="text-lg text-gray-600 mb-8 leading-relaxed">
                ...
                Olithea vous permet de définir des <strong>horaires types</strong> (semaines de référence)
            ...
            {{-- How --}}
            <h2 class="text-2xl font-semibold mb-4">
                Comment configurer ses disponibilités dans Olithea
            </h2>

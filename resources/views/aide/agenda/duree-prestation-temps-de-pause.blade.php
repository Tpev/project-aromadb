<x-app-layout>
    @section('title', 'Durée prestation et pauses agenda | Olithea')
    @section('meta_description')
Réglez durée des séances, limite quotidienne, préavis et temps entre deux rendez-vous pour un agenda praticien réaliste dans Olithea.
    @endsection
    ...
    <section class="py-16 bg-white">
        <div class="container mx-auto px-4 max-w-4xl">
            ...
            <p class="text-lg text-gray-600 mb-8 leading-relaxed">
                ...
                et prévoir un <strong>temps entre deux rendez-vous</strong>. Olithea combine ces paramètres pour proposer

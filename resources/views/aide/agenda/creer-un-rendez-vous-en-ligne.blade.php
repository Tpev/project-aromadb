...
Activez la prise de rendez-vous en ligne sur Olithea : prestations, modes de consultation, disponibilités et créneaux publiés sur votre Portail Pro.
    @endsection
    ...
    <section class="py-16 bg-white">
        <div class="container mx-auto px-4 max-w-4xl">
            ...
            <p class="text-lg text-gray-600 mb-8 leading-relaxed">
                Avec Olithea, vos clients peuvent réserver un créneau depuis votre

...
<body>
    <div class="container mt-5">
        ...
        <form action="{{ route('admin.marketing.templates.update', $template->id) }}" method="POST">
            @csrf
            @method('PUT')
            <div>
            ...
            <div>
                ...
                <textarea name="content" id="content" rows="10" required>{{ $template->content }}</textarea>
            </div>
            <button type="submit" class="upload-btn mt-4">Update Template</button>
        </form>
    </div>
</body>
</html>

    ...
    <div class="max-w-6xl mx-auto p-4 sm:p-6 lg:p-8 space-y-8">
        <section class="overflow-hidden rounded-[2rem] border border-[#dfe7c7] bg-[radial-gradient(circle_at_top_left,_rgba(224,235,198,0.72),_rgba(255,255,255,0.95)_45%,_rgba(244,240,231,0.95)_100%)] p-8 shadow-sm">
            <div class="flex flex-col gap-4 lg:flex-row lg:items-end lg:justify-between">
                <div>
                    <p class="text-xs font-semibold uppercase tracking-[0.24em] text-[#854f38]">Espace prive</p>
                    <h1 class="mt-2 text-3xl font-semibold tracking-tight text-gray-900">Mes communautes</h1>
                    <p class="mt-3 max-w-2xl text-sm leading-7 text-gray-600">Retrouvez ici les espaces de discussion prives auxquels votre praticien vous a invite, avec des salons lisibles, des annonces bien mises en avant et un acces simple a chaque groupe.</p>
                </div>
                <a href="{{ route('client.home') }}" class="inline-flex items-center rounded-full border border-[#d7ddc8] bg-white/90 px-4 py-2.5 text-sm font-semibold text-gray-700 shadow-sm hover:border-[#647a0b] hover:text-[#647a0b]">Retour a l'accueil</a>
            </div>
        </section>
            ...
            <section class="rounded-[2rem] border border-amber-200 bg-[linear-gradient(135deg,_rgba(255,248,230,1),_rgba(255,255,255,1))] p-6 shadow-sm">
                <div class="flex flex-col gap-4 lg:flex-row lg:items-center lg:justify-between">
                    <div>
                        ...
                        <p class="mt-2 text-sm leading-7 text-gray-600">Votre praticien vous ouvre l'acces a une ou plusieurs communautes privees. Chaque invitation reste visible ici jusqu'a votre reponse.</p>
                    </div>
                        ...
                        <article class="rounded-[1.8rem] border border-amber-200/70 bg-white/90 p-5 shadow-sm">
                            <div class="flex items-start justify-between gap-4">
                                <div>
                                    ...
                                    <p class="mt-2 text-sm leading-7 text-gray-600">{{ $membership->group->description ?: 'Votre praticien vous invite a rejoindre cet espace de discussion prive.' }}</p>
                                </div>
        ...
        <section class="rounded-[2rem] border border-[#eceee5] bg-white p-6 shadow-sm">
            <div class="flex flex-col gap-4 lg:flex-row lg:items-center lg:justify-between">
                <div>
                    <h2 class="text-xl font-semibold text-gray-900">Communautes actives</h2>
                    <p class="mt-2 text-sm leading-7 text-gray-600">Accedez a vos salons, relisez les annonces du praticien et poursuivez les echanges du groupe dans un environnement plus structure et plus premium.</p>
                </div>
            ...
            <div class="mt-5 grid gap-4 md:grid-cols-2 xl:grid-cols-3">
                @forelse($communities as $membership)
                    <article class="group overflow-hidden rounded-[1.8rem] border border-[#eceee5] bg-[linear-gradient(180deg,_rgba(249,250,246,1),_rgba(255,255,255,1))] p-5 shadow-sm transition hover:-translate-y-1 hover:shadow-lg hover:shadow-lime-900/5">
                        ...
                        <p class="mt-4 line-clamp-3 text-sm leading-7 text-gray-600">{{ $membership->group->description ?: 'Communaute privee animee par votre praticien.' }}</p>
                        <div class="mt-5 grid gap-3 sm:grid-cols-2">
                            ...
                            <div class="rounded-2xl bg-white/80 px-4 py-3 ring-1 ring-[#eef1e5]">
                                <p class="text-xs uppercase tracking-[0.16em] text-gray-500">Votre acces</p>
                ...
                @empty
                    <div class="md:col-span-2 xl:col-span-3 rounded-[1.8rem] border border-dashed border-[#d7dccb] bg-[#fafbf7] px-8 py-14 text-center">
                        ...
                        <p class="mt-5 text-base font-semibold text-gray-900">Aucune communaute active pour le moment</p>
                        <p class="mt-2 text-sm leading-7 text-gray-500">Lorsque votre praticien vous invitera, la communaute apparaitra ici et vous pourrez la rejoindre depuis cette page.</p>
                    </div>
                @endforelse
            </div>
        </section>

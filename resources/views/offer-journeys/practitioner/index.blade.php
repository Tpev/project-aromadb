<x-app-layout>
    <x-slot name="header">
        <div class="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
            <div>
                <h1 class="text-2xl font-semibold text-[#647a0b]">Parcours d’offre</h1>
    ...
    <div class="py-6">
        <div class="mx-auto max-w-7xl space-y-5 px-4 sm:px-6 lg:px-8">
            ...
            @else
                ...
                @if($journeys->isEmpty())
                    <section class="rounded-lg border border-dashed border-[#cbd5a5] bg-white px-6 py-10 text-center">
                        <h2 class="text-lg font-semibold text-gray-900">Créez votre premier parcours</h2>
                        <p class="mx-auto mt-2 max-w-xl text-sm leading-6 text-gray-600">
                            Choisissez ce que vous souhaitez proposer. Olithea prépare les étapes et rien ne devient visible avant votre publication.
                        </p>
                        <a href="{{ route('offer-journeys.create') }}" class="mt-5 inline-flex rounded-md bg-[#647a0b] px-4 py-2 text-sm font-semibold text-white hover:bg-[#526509]">
                            Commencer
                        </a>
                    </section>
                @else
                    <section class="overflow-hidden rounded-lg border border-gray-200 bg-white shadow-sm">
                        <div class="border-b border-gray-200 px-4 py-4 sm:px-5">
                            <h2 class="font-semibold text-gray-900">Vos parcours</h2>
                        </div>

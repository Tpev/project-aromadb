    ...
    <div class="sidebar-stack space-y-4">
        ...
        <div class="toolbar-card glass-card">
            ...
            <p id="noSelectionHint" class="text-[11px] text-slate-500">
                Selectionnez un element du canvas ou de la liste des calques.
            </p>
            ...
            <div id="selectionPanel" class="space-y-3 hidden">
                ...
                <div class="border-t border-dashed border-slate-200 pt-2">
                    ...
                    <div class="flex flex-wrap gap-1.5 mb-1.5">
                        ...
                        <button id="btnZBottom" type="button" class="z-order-btn" title="Mettre tout derriere">
                            Arriere-plan
                        </button>
                    </div>
                    <div class="flex flex-wrap gap-1.5">
                        <button id="btnDuplicate" type="button" class="z-order-btn" title="Dupliquer l'element">
                            Dupliquer
                        </button>
                        <button id="btnToggleLock" type="button" class="z-order-btn" title="Verrouiller ou deverrouiller">
                            Verrouiller
                        </button>
                        <button id="btnToggleVisibility" type="button" class="z-order-btn" title="Afficher ou masquer">
                            Masquer
                        </button>
                    </div>
                </div>

        ...
        <div class="container mx-auto max-w-4xl text-left">
            <article class="bg-white p-8 rounded-lg shadow-lg">
                ...
                <ul class="list-disc list-inside text-gray-700 mb-4">
                    ...
                    <li><strong>« Données Personnelles » :</strong> toute information se rapportant à une personne physique identifiée ou identifiable, au sens du Règlement Général sur la Protection des Données (RGPD).</li>
                </ul>
                ...
                <p class="text-gray-700">
                    L’Utilisateur souhaitant accéder à certains Services (par exemple, la prise de rendez-vous en ligne) doit créer un Compte Personnel et fournir des informations exactes, à jour et complètes.
                </p>
                <p class="text-gray-700">
                ...
                <p class="text-gray-700">
                    Les professionnels référencés sur la Plateforme ne sont pas des médecins généralistes ou spécialistes. Les pratiques douces doivent être considérées comme complémentaires et ne se substituent pas à un suivi médical conventionnel.
                </p>
                <p class="text-gray-700">
                    En cas de maladie grave ou de symptômes persistants, l’Utilisateur doit consulter un médecin ou un service d’urgence (15, 112, etc.).
                </p>
                <p class="text-gray-700">
                ...
                <p class="text-gray-700">
                    L’Utilisateur est seul responsable de l’utilisation qu’il fait de la Plateforme et de ses informations (sélection du Professionnel, prise de rendez-vous, etc.).
                </p>
                <p class="text-gray-700">
                ...
                <p class="text-gray-700">
                    Pour créer un Compte Personnel ou accéder à certains Services, l’Utilisateur renseigne des Données Personnelles (identité, coordonnées, etc.).
                    <br>
                ...
                <p class="text-gray-700">
                    Si l’une des clauses des CGU est jugée illégale, nulle ou inapplicable, les autres dispositions resteront pleinement en vigueur.
                </p>

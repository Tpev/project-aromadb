<x-app-layout>
    ...
    @section('title', 'Logiciel sophrologue – Agenda, dossiers clients & facturation | Olithea')
    @section('meta_description')
Olithea est un logiciel conçu pour les sophrologues : agenda et réservation en ligne, dossiers clients, questionnaires de suivi, facturation simple et visibilité pour développer votre activité de sophrologie.
    @endsection
        ...
        <div class="container mx-auto px-6 relative z-10">
            <div class="max-w-4xl">
                ...
                <p class="text-white text-lg md:text-xl opacity-90 leading-relaxed mb-8" data-aos="fade-up" data-aos-delay="100">
                    Olithea vous aide à organiser votre activité de sophrologue de façon fluide et professionnelle :
                ...
                <p class="text-white opacity-80 mt-6 text-sm" data-aos="fade-up" data-aos-delay="350">
                    Vous êtes sophrologue (séances individuelles, ateliers, accompagnement stress/émotions) ? Olithea vous aide à structurer votre quotidien et à gagner du temps.
                </p>
            </div>
        </div>
    </section>
            ...
            <div class="max-w-5xl mx-auto seo-text">
                <div class="text-center mb-10">
                    <h2 class="text-3xl md:text-4xl font-bold text-primary" data-aos="fade-up">
                        Olithea : un logiciel de sophrologie pensé pour le quotidien
                    </h2>
                ...
                <div class="grid grid-cols-1 lg:grid-cols-2 gap-10" data-aos="fade-up">
                    <div class="feature-card p-8">
                        ...
                        <p class="mt-3">
                            ...
                            à rechercher des notes ou à reconstituer l’historique d’un client. Olithea rassemble vos informations
                ...
                <div class="grid grid-cols-1 lg:grid-cols-2 gap-10 mt-10" data-aos="fade-up">
                    <div class="feature-card p-8">
                        ...
                        <p class="mt-3">
                            ...
                            et faciles à retrouver. Olithea vous aide à générer devis et factures en quelques clics et à
            ...
            <div class="accordion max-w-3xl mx-auto mt-10" data-aos="fade-up">
                <div class="accordion-item">
                    ...
                    <div class="accordion-content">
                        Choisissez un outil simple qui centralise agenda, dossiers, suivi et facturation. Olithea est pensé pour un usage quotidien, rapide à prendre en main.
                    </div>
                </div>
                ...
                <div class="accordion-item">
                    ...
                    <div class="accordion-content">
                        Oui, Olithea propose un essai gratuit de 14 jours, sans engagement.
                    </div>
                </div>
            </div>
        </div>
          ...
          "mainEntity": [
            {
              ...
              "acceptedAnswer": {
                "@type": "Answer",
                "text": "Choisissez un outil simple qui centralise agenda, dossiers, suivi et facturation. Olithea est pensé pour un usage quotidien, rapide à prendre en main."
              }
            },
            {
              "@type": "Question",
        ...
        <div class="container mx-auto px-6">
            <div class="max-w-4xl mx-auto text-center feature-card p-10" data-aos="zoom-in">
                <h2 class="text-3xl md:text-4xl font-bold mb-4 text-primary">
                    Essayez le logiciel sophrologue Olithea
                </h2>

{{-- resources/views/formation/Utilisateur-Aromatherapie46.blade.php --}}
<x-app-layout>
    <x-slot name="header">
        <h2 class="font-semibold text-xl text-center" style="color: #6B4A3A;">
...
.progress-bar {
    ...
    border-radius: 8px;
        ...
        <!-- Diapositive 46 : Quizz rapide – Question 2 -->
        <div class="slide-content">
            <h1 class="slide-title">Quizz rapide – Question 2</h1>

            <p style="font-size: 1.2rem; color: #333333; margin-bottom: 20px;">
                Quel mélange rapide serait efficace pour dégager les voies respiratoires ?
            </p>
            ...
            <form id="quiz-form">
                ...
                <div class="details-box">
                    <label>
                        ...
                        b) 2 gouttes d'eucalyptus + 1 goutte de menthe poivrée
                    </label>
                </div>
                <div class="details-box">
                    <label>
                        <input type="radio" name="answer" value="c">
                        c) 4 gouttes de menthe poivrée + 4 gouttes de citron
                    </label>
                </div>

{{-- resources/views/formation/Utilisateur-Aromatherapie22.blade.php --}}
<x-app-layout>
    <x-slot name="header">
...
.progress-bar {
    ...
    border-radius: 8px;
        ...
        <!-- Diapositive 22 : Quiz rapide (Question 3) -->
        <h1 class="slide-title">Quiz rapide – Question 3</h1>

        <p style="font-size: 1.2rem; color: #333333; margin-bottom: 20px;">
            Quelle huile essentielle est souvent utilisée pour dégager les voies respiratoires et soulager un rhume ?
        </p>

{{-- resources/views/formation/Utilisateur-Aromatherapie34.blade.php --}}
<x-app-layout>
    <x-slot name="header">
...
.progress-bar {
    ...
    border-radius: 8px;
        ...
        <!-- Diapositive 34 : Évaluation – Quiz (Question 3) -->
        <div class="slide-content">
            <h1 class="slide-title">Évaluation – Quiz (Question 3)</h1>

            <p style="font-size: 1.2rem; color: #333333; margin-bottom: 20px;">
                Quelle huile essentielle est considérée comme sûre pour les femmes enceintes lorsqu’elle est diluée correctement ?
            </p>

...
<x-app-layout>
    ...
    <div class="flex justify-center mb-8 px-4">
        <div class="w-full max-w-5xl bg-white border border-gray-200 rounded-lg sm:rounded-full p-3 sm:p-6 shadow-xl">
            <form action="{{ route('therapists.search') }}" method="POST" class="grid grid-cols-1 md:grid-cols-4 gap-4 w-full">
                @csrf

                <!-- Name (fuzzy) -->
                <div class="md:col-span-1">
                    <label for="name" class="sr-only">Nom du praticien</label>
                    <input
                        type="text"
                        name="name"
                        id="name"

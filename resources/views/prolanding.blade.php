<x-app-layout>
    @section('title', 'Olithea | Le logiciel pour praticiens du bien-être')
    @section('meta_description', 'Olithea centralise rendez-vous, suivi client, facturation, paiements, visio, visibilité en ligne et communication pour les praticiens du bien-être.')

    @section('meta_og')
        <meta property="og:type" content="website">
        <meta property="og:locale" content="fr_FR">
        <meta property="og:url" content="{{ url()->current() }}">
        <meta property="og:title" content="Olithea | Le logiciel pour praticiens du bien-être">
        ...
        <meta name="twitter:title" content="Olithea | Le logiciel pour praticiens du bien-être">
        ...
        <div class="pro-wrap pro-hero-grid">
            <div class="pro-hero-copy">
                ...
                <p class="pro-subtitle">
                    ...
                    Olithea vous permet de tout piloter sans empiler plusieurs outils.
    ...
    <section class="pro-section">
        <div class="pro-wrap">
            <header class="pro-head">
                ...
                <h2>Pourquoi des praticiens choisissent Olithea</h2>
            </header>
    ...
    <section class="pro-section" id="faq">
        <div class="pro-wrap">
            ...
            <div class="pro-faq-grid">
                ...
                <details><summary>Pourquoi éviter d'assembler plusieurs logiciels séparés ?</summary><p>Parce que cela augmente les coûts, la complexité et les risques d'erreurs. Avec Olithea, tout reste synchronisé dans un seul environnement.</p></details>
    ...
    <section class="pro-final-cta">
        <div class="pro-wrap pro-center">
            ...
            <p>Essayez Olithea et voyez rapidement l'impact sur votre organisation et votre croissance.</p>

<x-app-layout>
    ...
    <div class="hero bg-cover bg-center flex items-center justify-center" style="background-image: url('{{ asset('images/hero-background.jpg') }}'); height: 70vh;">
        <div class="container mx-auto text-center">
            <!-- Display Logo -->
            <img src="{{ asset('images/png-01.png') }}" alt="AromaMade Logo" class="mx-auto" style="max-width: 800px; height: auto;">
        </div>
    </div>

    <!-- Features Section (Nos Catégories) -->
    <section class="py-8 bg-white"> <!-- Reduced padding here -->
        <div class="container mx-auto">
            <h2 class="text-3xl font-bold text-center mb-4"><i class="fas fa-th-large mr-2"></i>Nos catégories</h2> <!-- Reduced margin here -->
            <div class="grid grid-cols-1 md:grid-cols-4 gap-8">
                <!-- Huile Essentielle -->
                <div class="text-center bg-gray-100 p-6 rounded-lg shadow"> <!-- Reduced padding -->
                    <i class="fas fa-leaf text-6xl text-green-500 mb-4"></i>
                    <h3 class="text-2xl font-bold mb-4">Huiles Essentielles</h3>
                    <p class="text-lg mb-4">
    Découvrez des informations fiables sur les huiles essentielles : leurs bienfaits, usages, et précautions, pour un usage éclairé et responsable.
</p>
                ...
                <div class="text-center bg-gray-100 p-6 rounded-lg shadow"> <!-- Reduced padding -->
                   ...
                   <p class="text-lg mb-4">
    Explorez les tisanes, où chaque infusion est accompagnée d'informations précises et vérifiées. Que ce soit pour la relaxation ou pour leurs vertus spécifiques.
</p>
<a href="{{ route('tisanes.index') }}" class="btn-primary">Voir plus</a>
                ...
                <div class="text-center bg-gray-100 p-6 rounded-lg shadow"> <!-- Reduced padding -->
					...
					<p class="text-lg mb-4">
    Explorez des recettes naturelles soigneusement élaborées pour soutenir votre bien-être, tout en mettant en avant l’efficacité des huiles essentielles, végétales, et tisanes. </p>
    ...
    <!-- About Us Section -->
    <section class="py-8 bg-gray-100"> <!-- Reduced padding here -->
        <div class="container mx-auto">
            <h2 class="text-3xl font-bold text-center mb-4"><i class="fas fa-info-circle mr-2"></i>À propos de nous</h2> <!-- Reduced margin here -->

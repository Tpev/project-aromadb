<x-app-layout>
    ...
    @php
        ...
        $selectedCorporateId = old('corporate_client_id', request('corporate_client_id', request('company_id')));

        $billTo = old('bill_to', $selectedCorporateId ? 'corporate' : 'person');

        // Fallback if controller didn't pass corporate clients (avoid breaking existing flows)
                ...
                <div class="am-section">
                    <div class="am-section-head am-section-head--row">
                        ...
                        <div class="am-actions">
                            ...
                            <button type="button" class="am-btn am-btn-primary" onclick="openPackModal()">
                                {{ __('Ajouter un pack') }}
                            </button>
    ...
    <script>
        ...
        function addPackItem() {
            ...
            row.innerHTML = `
                <td class="am-td am-td--type"><span class="am-pill am-pill--alt">Pack</span></td>
                <td class="am-td am-td--product">
                    <input type="hidden" name="items[${idx}][type]" value="custom">
                    <input type="hidden" name="items[${idx}][product_id]" value="">
                    <input type="hidden" name="items[${idx}][inventory_item_id]" value="">
    ...
    <style>
        ...
        .am-pill--alt{
            background: rgba(107, 74, 58,.12);
            border-color: rgba(107, 74, 58,.25);
        }
        .am-pill--inv{

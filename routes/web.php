...
Route::post('/training-access/{token}/blocks/{block}/complete', [PublicTrainingAccessController::class, 'markBlockCompleted'])
    ->name('digital-trainings.access.blocks.complete');

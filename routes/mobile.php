...
Route::middleware('web')
    ...
    ->group(function () {
        ...
        Route::middleware('auth')->group(function () {
            ...
            Route::post('/pack-purchases/{packPurchase}/digital-access/resend', [MobilePackProductController::class, 'resendDigitalAccess'])->name('packs.purchases.digital-access.resend');

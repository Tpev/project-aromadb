...
function superPdpTestConfig(): void
{
    config([
        ...
        'services.super_pdp.redirect_uri' => 'https://olithea.test/super-pdp/oauth/callback',
...
test('starting onboarding redirects to the super pdp authorization endpoint', function () {
    ...
    expect($query['redirect_uri'])->toBe('https://olithea.test/super-pdp/oauth/callback');
